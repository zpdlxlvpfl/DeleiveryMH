						...
						<div class="col-md-8">
							<div class="left-text">
								<div class="testimonials-item">
									...
									<c:forEach items="${HashMapList}" var="res_menu_code" begin="0"
										end="0" step="1" varStatus="i">
										<h4>
											<c:out value=" ${res_menu_code.res_menu_name}">
											</c:out>
										</h4><div class="line-dec"></div>
										<p>
							...
							<div class="left-text">
								<div class="testimonials-item">
									...
									<c:forEach items="${HashMapList}" var="res_menu_code" begin="6"
										...
										<p> <c:out value=" ${res_menu_code.res_menu_explan}"/></p>
										<span><c:out value="${res_menu_code.res_menu_price}"></c:out>
											&#8361;</span>
									</c:forEach>
									<div class="primary-button">

...
<div class="contact-form">
        ...
        <label> <font color="white"> Res Name : </font> </label><input name = "RES_NAME" type = "text" value = "${RES_CODE.RES_NAME}">
        <br>
        <label><font color="white"> Res Info : </font> </label> <input name = "RES_INFO" type = "text" value = "${RES_CODE.RES_INFO}">
        <br>
        <label><font color="white"> Del price : </font> </label><input name = "DEL_PRICE" type = "text" value = "${RES_CODE.DEL_PRICE}">
  
    <div class="primary-button">
    <button type="button" id="updateres_btn" class="btn" name="updateres_btn"
   style="font-family: inherit; color:white; background-color:#FE9A2E; width: 100px; height: 30px;" >Update</button>
    ...
    $("#updateres_btn").click(function(){
        var frm = $("#frm").serialize(); 
        var RES_CODE = $("#RES_CODE").val();
        $.ajax({
            type : "get", 
            url : "/restaurant/updateRes", 
            data : frm, 
            async : false, 
            dataType : "json", 

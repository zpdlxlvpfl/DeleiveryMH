...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul class="list-unstyled">
              ...
              <li><a href="../resources/docs/help/#api">API</a></li>
              <li><a href="../resources/docs/help/#donate">Donate</a></li>
            </ul>
    ...
    <script src="../resources/docs/_vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
